...
## Project Overview
This project is a Practical 5 extension of the existing Task Manager API. It keeps the same Express routes and middleware while replacing the in-memory array with MongoDB and Mongoose for persistent task storage.
